...
# Description:     This is a python script that accepts the output of `aws sts get-session-token` as stdin to create the appropriate environment variables (making it transiently effective).
#
# Notes
# - This plays much more nicely in a zsh environment than it does in bash based off of how it handles pipelining.
#
# =========================
